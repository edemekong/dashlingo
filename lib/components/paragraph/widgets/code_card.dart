            ...
            if (output)
              ...
              HighlightView(
                ...
                theme: {
                  ...
                  'addition':
                      textStyle.copyWith(color: const Color(0xff55a532), backgroundColor: const Color(0xffeaffea)),
                  'deletion':
                      textStyle.copyWith(color: const Color(0xffbd2c00), backgroundColor: const Color(0xffffecec)),
